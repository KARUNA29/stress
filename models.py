...
class UserImageEmotions(models.Model):
    username = models.CharField(max_length=100)
    emotions = models.CharField(max_length=100)
    loginid = models.CharField(max_length=100)  # Assuming loginid is a CharField

    # Additional fields and methods may be defined here as needed
